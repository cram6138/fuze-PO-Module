...
public class ContainerRepositoryPlSql {
	...
	public List<Container> callProcedureForSearchContainer(@Valid ContainerForm containerForm) {
		...
		query.setParameter(8,containerForm.getTerritory()/*(containerForm.getUserInfo()!= null)?containerForm.getUserInfo().getTerritory():null*/);
		query.setParameter(9,containerForm.getMarket()/*(containerForm.getUserInfo()!= null)?containerForm.getUserInfo().getMarket():null*/);
